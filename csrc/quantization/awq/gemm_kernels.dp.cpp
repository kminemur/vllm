    ...
    int split_k_iters)
{
    ...
    auto in_feats = reinterpret_cast<sycl::half*>(_in_feats.data_ptr<at::Half>());
    auto kernel = reinterpret_cast<int*>(_kernel.data_ptr<int>());
    auto out_feats = reinterpret_cast<sycl::half*>(_out_feats.data_ptr<at::Half>());
    auto scaling_factors = reinterpret_cast<sycl::half*>(_scaling_factors.data_ptr<at::Half>());
    ...
    const dpct::queue_ptr q = &dpct::get_default_queue();
    if (num_out_channels % 128 == 0)
    {
        ...
        {
            dpct::has_capability_or_fail(q->get_device(),
                                         {sycl::aspect::fp16});
            q->parallel_for(
                ...
                [=](sycl::nd_item<3> item_ct1) {
                    vllm::awq::gemm_forward_4bit_cuda_m16n128k32(
                        ...
                        scaling_factors, zeros, num_in_feats, num_in_channels,
