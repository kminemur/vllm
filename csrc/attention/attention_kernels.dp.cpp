...
// #include <ATen/cuda/CUDAContext.h> // no need for sycl
...
#pragma unroll
  for (int mask = WARP_SIZE / 2; mask >= 1; mask /= 2) {
    ...
    */
    /*
    DPCT1064:11: Migrated __shfl_xor_sync call is used in a macro/template
    definition and may not be valid for all macro/template uses. Adjust the
    code.
    */
    /*
    DPCT1096:55: The right-most dimension of the work-group used in the SYCL
...
#pragma unroll
  for (int mask = NUM_WARPS / 2; mask >= 1; mask /= 2) {
    ...
    */
    /*
    DPCT1096:56: The right-most dimension of the work-group used in the SYCL
    kernel that calls this function may be less than "32". The function
    "dpct::permute_sub_group_by_xor" may return an unexpected result on the CPU
    device. Modify the size of the work-group to ensure that the value of the
    right-most dimension is a multiple of "32".
  ...
  */
  /*
  DPCT1096:57: The right-most dimension of the work-group used in the SYCL
  kernel that calls this function may be less than "32". The function
...
//       */
//       /*
//       DPCT1064:21: Migrated __shfl_xor_sync call is used in a macro/template
//       definition and may not be valid for all macro/template uses. Adjust the
//       code.
//       */
//       /*
//       DPCT1096:54: The right-most dimension of the work-group used in the SYCL
//       kernel that calls this function may be less than "32". The function
...
//       */
//       acc +=
//           dpct::permute_sub_group_by_xor(item_ct1.get_sub_group(), acc, mask);
//     }
//     accs[i] = acc;
//   }
...
//     */
//     /*
//     DPCT1064:25: Migrated __shfl_xor_sync call is used in a macro/template
//     definition and may not be valid for all macro/template uses. Adjust the
//     code.
//     */
//     /*
//     DPCT1096:58: The right-most dimension of the work-group used in the SYCL
//     kernel that calls this function may be less than "32". The function
//     "dpct::permute_sub_group_by_xor" may return an unexpected result on the CPU
//     device. Modify the size of the work-group to ensure that the value of the
//     right-most dimension is a multiple of "32".
//     */
//     max_logit =
//         sycl::fmax(max_logit, dpct::permute_sub_group_by_xor(
...
//     */
//     /*
//     DPCT1096:59: The right-most dimension of the work-group used in the SYCL
//     kernel that calls this function may be less than "32". The function
//     "dpct::permute_sub_group_by_xor" may return an unexpected result on the CPU
//     device. Modify the size of the work-group to ensure that the value of the
//     right-most dimension is a multiple of "32".
...
//   */
//   /*
//   DPCT1064:28: Migrated __shfl_sync call is used in a macro/template definition
//   and may not be valid for all macro/template uses. Adjust the code.
//   */
//   /*
//   DPCT1096:60: The right-most dimension of the work-group used in the SYCL
//   kernel that calls this function may be less than "32". The function
//   "dpct::select_from_sub_group" may return an unexpected result on the CPU
//   device. Modify the size of the work-group to ensure that the value of the
//   right-most dimension is a multiple of "32".
...
/*
DPCT1049:29: The work-group size passed to the SYCL kernel may exceed the limit.
...
void paged_attention_v1_launcher(
  ...
  /*
  DPCT1083:30: The size of local memory in the migrated code may be different
  ...
  */
  ...
  using K_vec = typename vllm::Vec<T, VEC_SIZE>::Type;
  using Q_vec = typename vllm::Vec<T, VEC_SIZE>::Type;
  int NUM_ELEMS_PER_THREAD = head_size / THREAD_GROUP_SIZE;
  int NUM_VECS_PER_THREAD = NUM_ELEMS_PER_THREAD / VEC_SIZE;
  ...
  switch (head_size) {
    ...
    case 64:
      /*
      DPCT1027:45: The call to cudaFuncSetAttribute was replaced with 0 because
      SYCL currently does not support corresponding setting.
      */
      LAUNCH_PAGED_ATTENTION_V1(64);
    case 80:
      /*
      DPCT1027:46: The call to cudaFuncSetAttribute was replaced with 0 because
      SYCL currently does not support corresponding setting.
      */
    ...
    case 96:
      /*
      DPCT1027:47: The call to cudaFuncSetAttribute was replaced with 0 because
      SYCL currently does not support corresponding setting.
      */
    ...
    case 112:
      /*
      DPCT1027:48: The call to cudaFuncSetAttribute was replaced with 0 because
      SYCL currently does not support corresponding setting.
      */
    ...
    case 128:
      /*
      DPCT1027:49: The call to cudaFuncSetAttribute was replaced with 0 because
      SYCL currently does not support corresponding setting.
      */
    ...
    case 256:
      /*
      DPCT1027:50: The call to cudaFuncSetAttribute was replaced with 0 because
      SYCL currently does not support corresponding setting.
      */
...
/*
DPCT1049:31: The work-group size passed to the SYCL kernel may exceed the limit.
To get the device limit, query info::device::max_work_group_size. Adjust the
work-group size if needed.
*/
/*
...
void paged_attention_v2_launcher(
  ...
  /*
  DPCT1083:34: The size of local memory in the migrated code may be different
  from the original code. Check that the allocated memory size in the migrated
  code is correct.
  */
  ...
  /*
  DPCT1083:32: The size of local memory in the migrated code may be different
  from the original code. Check that the allocated memory size in the migrated
  code is correct.
  */
